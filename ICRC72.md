...
- **config** (Text, `ICRC16`): New configuration settings to replace or update the existing subscription configurations. 
...
2. Broadcaster will receive Broadcaster assignments via a notification that has a data structure as follows:
  ...
  - `icrc72:broadcaster:relayer:add`: Array[Array[Text,Blob]] - optional - targetBroadcaster Principal as Blob - broadcaster being added as an event relayer and the target broadcaster
  - `icrc72:broadcaster:relayer:remove`: Array[Array[Text,Blob]] - optional - targetBroadcaster Principal as Blob - broadcaster being removed as an event relayer and the target broadcaster
